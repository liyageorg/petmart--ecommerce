<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminreg.aspx.cs" Inherits="PET_MART.adminreg" %>
...
">
    ...
    <tr>
        ...
        <td style="padding:10px;">
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                ...
                style="color:red; font-size:13px;"> </asp:RequiredFieldValidator>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td style="padding:10px;">
            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server"
                ...
                style="color:red; font-size:13px;"> </asp:RegularExpressionValidator>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td style="padding:10px;">
            <asp:Label ID="Label6" runat="server" Text="Phone"
                style="color:#000; font-weight:600;"></asp:Label>
        </td>
